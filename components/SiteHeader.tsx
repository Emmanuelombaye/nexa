...
const treatmentMenuRows: MenuRow[] = [
  {
    ...
    heading: 'Tirzepatide',
    caption: 'Weight Loss',
    thumb: '/images/nexa/vial-tirzepatide.webp?v=3',
  ...
  },
  {
    ...
    heading: 'Semaglutide',
    caption: 'Weight Loss',
    thumb: '/images/nexa/vial-semaglutide.webp?v=3',
  ...
  },
  {
    ...
    allThumbs: [
      '/images/nexa/vial-semaglutide.webp?v=3',
      '/images/nexa/vial-tirzepatide.webp?v=3',
      '/images/nexa/vial-semaglutide.webp?v=3',
    ],
  },
]
