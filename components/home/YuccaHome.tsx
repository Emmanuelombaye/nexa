...
function HeroSection() {
  ...
  return (
    <section className="retro-home-hero-section pax-home-hero" data-hero-reveal data-revealed="true">
      ...
      <div className="retro-social-proof" data-layout="hero" aria-label="Nexa Rx trust and recognition">
        ...
        <div className="retro-happy__reviews-card">
          <div className="retro-happy__reviews-inner">
            <div className="retro-happy__reviews-google-text">
              <span className="retro-happy__reviews-google-label">Patient satisfaction 4.7 · 1,000+ reviews</span>
            </div>
            <div className="retro-happy__reviews-divider" />
            <div className="retro-happy__reviews-google-text">
              <span className="retro-happy__reviews-google-label">Care team rating</span>
              <div className="retro-happy__reviews-google-rating">
                <strong>4.8</strong>
                <span className="retro-happy__reviews-google-count">Excellent support</span>
              </div>
            </div>
          </div>
        </div>
...
function StatbandSection() {
  return (
    <section className="retro-home-statband" aria-label="20,000+ patients trust Nexa Rx">
      <div className="retro-home-statband-photo retro-home-statband-photo--left">
        <img src={HOME_STATBAND.left} alt="" loading="lazy" className="retro-home-statband-img" />
      </div>
      <div className="retro-home-statband-text">
        ...
        <p className="retro-home-statband-copy">
          patients have trusted Nexa Rx for their <span className="retro-home-statband-em">weight loss</span> treatment, and we&rsquo;re excited to help do the same for you!
        </p>
      </div>
      <div className="retro-home-statband-photo retro-home-statband-photo--right">
        <img src={HOME_STATBAND.right} alt="" loading="lazy" className="retro-home-statband-img" />
      </div>
    </section>
  )
}

function DoctorCard({ doc, carousel = false }: { doc: (typeof DOCTORS)[number]; carousel?: boolean }) {
  return (
    <article className={`retro-home-doctor-card${carousel ? ' retro-home-doctor-card--carousel' : ''}`}>
      <div className="retro-home-doctor-photo-wrap">
        <img src={doc.image} alt={`${doc.name}, ${doc.title}`} loading="lazy" className="retro-home-doctor-photo" />
    ...
    <section className="retro-home-doctors">
      <div className="retro-home-doctors-heading-wrap">
        <h2 className="retro-home-doctors-heading">
          ...
          physicians who will <em>guide</em> <br />
          and <em>support you</em>
        </h2>
      </div>
